% magic comments for TeXworks (including TeXShop): https://www.tug.org/TUGboat/tb32-1/tb100wright-texworks.pdf
% !TEX TS-program = LuaLaTeX
% !BIB TS-program = biber

%figtreepath=kthphdthesis/fonts/figtree/fonts/otf/
\documentclass{kthpq-thesis}

% Custom biblatex package to have cool macros
\usepackage[%
	backend=biber,% default is biber
	bibstyle=numeric,
	maxnames=99,
	isbn=false,
	url=false
]{kthpq/biblatex-kthpq}
...
\begin{verbatim}
\setmathfont{Other Font}[Scale=\fontscale]
\end{verbatim}
...
\item Make it possible to load HTML colors?
\item Put command arguments in $\langle\textit{brackets}\rangle$.
\item Move things out of the template documents to make them simpler (not sure how much more I can do)
\item \lipsum[23]
\end{enumerate}
...
\papertitlepage[color=light blue,submitted]{GLRS2025}
